...
FileExplorer::FileExplorer():folderView(Vector2f(350, 600)),ribbon(&folderView, Vector2f(600, 100))
{
...
void FileExplorer::populateNode(TreeNode * ptr, Texture & ft, Font & f)
{
	string address = "\\";
	for (TreeNode * tn = ptr; tn != nullptr; tn = tn->getParent())
	{
...
void FileExplorer::loadDrives(TreeNode * root, Texture & ft, Font & f)
{
